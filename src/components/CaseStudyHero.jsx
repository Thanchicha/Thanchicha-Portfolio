...
export default function CaseStudyHero({ project }) {
  return (
    <header className="case-study-hero border-b border-gray-200 px-6 pb-16 pt-36 dark:border-gray-800 md:px-12 lg:px-20">
      <div className="mx-auto max-w-[1100px]">
        ...
        <ProjectVisual project={project} className="case-study-cover" />
      </div>
    </header>
  );
}
